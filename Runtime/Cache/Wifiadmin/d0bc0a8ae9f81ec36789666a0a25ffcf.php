...
<!-- end sidebar --> 
    ...
    <div class="content" style="height: 100%;">
        ...
        <div class="row-fluid form-wrapper" style="margin-left:20px;">
            <form method="get" action="__URL__/user">

                <div class="span6 column" style="width:100%;">
                    <div>
                        <div class="span6 field-box" style="width:auto;">
                            <label class="span4" style="width:80px;">USER_MAC:</label>
                            <input class="span8" type="text" name="user_mac"  style="width:150px;">
                        </div>
                        <div class="span6 field-box" style="width:auto; margin-left:10px;">
                            <label class="span4" style="width:70px;">AP_MAC:</label>
                            <input class="span8" type="text" name="ap_mac" style="width:150px;">
                        </div>
                ...
                <div class="">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th class="col-md-2"> <span class="line"></span> user_mac</th>
                            <th class="col-md-2"> <span class="line"></span> ap_mac</th>
                            <th class="col-md-2"> <span class="line"></span> 上线时间</th>
                            <th class="col-md-2"> <span class="line"></span> 下线时间</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><td><?php echo ($vo['hostaddress']); ?></td>
                            <td><?php echo ($vo['ap']); ?></td>
                            <td><?php echo (date('Y-m-d H:i:s',$vo['times'])); ?></td>
                            <td>
                            <?php if(empty($vo["outtime"])): ?>当前在线
                            <?php else: ?>
                            	<?php echo (date('Y-m-d H:i:s',$vo['outtime'])); endif; ?>
                            </td>
