            ...
            <div class="row-fluid form-wrapper"style="margin-left:20px;">
                <form method="post">
                    ...
                    <div class="span6 column" style="width:100%;">
                        <div>
                            <div class="span6 field-box" style="width:250px;">
                                <label class="span4" style="width:90px;">广告位名称:</label>
                                <input class="span8" type="text" name="sname" style="width:150px;">
                            </div>
                            <div class="span6 field-box" style="width:250px;">
                                <label class="span4" style="width:90px;">广告位备注:</label>
                                <input class="span8" type="text" name="sremark" style="width:150px;">
                            </div>
                        </div>
            ...
            <div class="">
                <table class="table table-hover">
                    ...
                    <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!-- row -->
                        ...
                        <td>
                            <a href="<?php echo U('editadvertise',array('id'=>$vo['id']));?>">编辑</a>|
                            <a href="<?php echo U('deladvertise',array('id'=>$vo['id']));?>">删除</a>|
                            <a href="<?php echo U('oddrpt',array('id'=>$vo['id']));?>">查看统计</a>|
                            <a href="<?php echo U('index',array('advid'=>$vo['id']));?>">查看广告</a>
                        </td>
